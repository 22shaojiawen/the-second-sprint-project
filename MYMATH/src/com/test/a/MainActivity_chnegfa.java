...
import java.math.*;
public class MainActivity_chnegfa extends Activity {
...
private RadioButton radio3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chujichengfa);
		...
		break;	
			...
			public void onClick(View v){
				...
				if(radio1.isChecked())
				{
					if(shu4==1)
					{
					Toast.makeText( MainActivity_chnegfa.this, "正确", 
					Toast.LENGTH_SHORT).show();
					
					}
					else
					{
					Toast.makeText( MainActivity_chnegfa.this, "错误", 
					Toast.LENGTH_SHORT).show(); 
